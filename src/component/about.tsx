...
<div   className='max-w-2xl m-auto text-center text-2xl px-5 flex justify-center items-center  my-10   font-medium'>This project aims to meet the needs of the reader and learner by combining diverse books and accurate sources to combine ease and education.</div>
    ...
    <div data-aos="zoom-in-up" className='  h-fit  p-10  mb-20 flex flex-col-reverse items-center  justify-center gap-20 md:flex-row '>  
            ...
            {/* ----------img------------ */}
              <img data-aos="zoom-in-up" className='   w-full md:w-2/5' src="https://images.pexels.com/photos/1083633/pexels-photo-1083633.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
...
{/* --------------content section two----------------- */}
    ...
    <div  data-aos="zoom-in-up" className='h-fit  p-10 flex flex-col-reverse items-center justify-center gap-20 md:flex-row-reverse '>  
            ...
            {/* ----------img------------ */}
              <img  data-aos="zoom-in-up" className='   w-full md:w-2/5' src="https://images.pexels.com/photos/1808200/pexels-photo-1808200.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
