  ...
  return (
    <section className="w-full flex pt-10 ">
      <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
        <div className="relative z-10 w-full max-w-md">
          <h1 className="flex items-center gap-3 text-2xl font-bold text-white">
            <Image src="/Logo.png" alt="icon logo" width={50} height={50} />
            School
          </h1>

          <div className=" mt-6 space-y-3">
            <h3 className="text-white text-3xl font-bold">
              Start your lessons now and become a doctor
            </h3>
      ...
      <div className="flex-1 flex items-center justify-center h-screen">
        <div className="w-full max-w-md space-y-8 px-4 dark:text-gray-300 text-gray-600 sm:px-0">
          <div className="">
            <Image
              className="lg:hidden"
              src="/Logo.png"
            ...
            <div className="mt-5 space-y-2">
              <h3 className="dark:text-gray-300 text-gray-800 text-2xl font-bold sm:text-3xl">
                Sign up
              </h3>
              <p className="">
          ...
          <div className="relative">
            ...
            <p className="inline-block w-fit text-sm dark:bg-neutral-900 bg-gray-100 px-2 absolute -top-2 inset-x-0 mx-auto duration-150">
              Or continue with
            </p>
          </div>
          <form
          ...
          >
            <div>
              ...
              <input
                type="text"
                required
                className="w-full mt-2 px-3 py-2 text-gray-600 dark:text-gray-300 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
              />
            </div>
            <div>
